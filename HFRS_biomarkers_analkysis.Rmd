...
hosp_seven_cv<-mean(replicate(1,cv.lm(linear_model_hosp_sub_seven,k=10)$MSE$mean))
...
chr_five_cv<-mean(replicate(1,cv.lm(linear_model_chreatinine_sub_five,k=10)$MSE$mean))
...
pro_four_cv<-mean(replicate(1,cv.lm(linear_model_NT_proBNP_sub_four,k=10)$MSE$mean))
...
lipo_five_cv<-mean(replicate(1,cv.lm(linear_model_lipo_sub_five,k=10)$MSE$mean))
...
endo_two_cv<-mean(replicate(1,cv.lm(linear_model_endo_sub_two,k=10)$MSE$mean))
