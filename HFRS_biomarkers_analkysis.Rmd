...
patients_dataset_num<-patients_dataset[,.SD,.SDcols=c("Patient ID","Age","Length of hospitalization (days)","Acute-phase serum NT-proBNP (ng/L)","Convalescent-phase serum NT-proBNP (ng/L)","Acute-phase urine NT-proBNP (ng/L)","Acute-phase serum endothelin-1 (pg/mL)","Convalescent-phase serum endothelin-1 (pg/mL)","Acute-phase urine endothelin-1 (pg/mL)","Convalescent-phase urine endothelin-1 (pg/mL)","Acute-phase serum lipocalin-2 (ng/mL)","Convalescent-phase serum lipocalin-2 (ng/mL)","Acute-phase urine lipocalin-2 (ng/mL)","Convalescent-phase urine lipocalin-2 (ng/mL)","Max. serum RBC count (*10^12/L)","Max. sedimentation rate (mm/h)","Min. platelet count (10^9/L)","Max. serum WBC count (*10^9/L)","Max. CRP (mg/L)","Max. creatinine (umol/L)","Max. urea (mmol/L)","Min. urine volume (mL/day)","Max. urine RBC count (RBC/HPF)","Max. urine WBC count (WBC/HPF)","Proteinuria","AST on admission (U/L)","ALT on admission (U/L)","GGT on admission (U/L)")]
...
linear_model_endo_sub_two<-lm(`Acute-phase urine endothelin-1`~`Max. urine WBC count (WBC/HPF)`+`Acute-phase urine lipocalin-2`,data=patients_dataset_num_cp)

summary(linear_model_endo_sub_two)

#Methodology for choosing the best model - only the best model is shown

x_endo_two<-model.matrix(`Acute-phase urine endothelin-1`~`Max. urine WBC count (WBC/HPF)`+`Acute-phase urine lipocalin-2`,data=patients_dataset_num_cp)
