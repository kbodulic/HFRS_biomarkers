...
patients_dataset_num<-patients_dataset[,.SD,.SDcols=c("Patient ID","Age","Length of hospitalization (days)","First serum NT-proBNP (ng/L)","Second serum NT-proBNP (ng/L)","First urine NT-proBNP (ng/L)","First serum endothelin-1 (pg/mL)","Second serum endothelin-1 (pg/mL)","First urine endothelin-1 (pg/mL)","Second urine endothelin-1 (pg/mL)","First serum lipocalin-2 (ng/mL)","Second serum lipocalin-2 (ng/mL)","First urine lipocalin-2 (ng/mL)","Second urine lipocalin-2 (ng/mL)","Max. serum RBC count (*10^12/L)","Max. sedimentation rate (mm/h)","Min. platelet count (10^9/L)","Max. serum WBC count (*10^9/L)","Max. CRP (mg/L)","Max. creatinine (umol/L)","Max. urea (mmol/L)","Min. urine volume (mL/day)","Max. urine RBC count (RBC/HPF)","Max. urine WBC count (WBC/HPF)","Proteinuria","Max. ALT (U/L)","Max. ALT (U/L)","Max. GGT (U/L)")]



setnames(patients_dataset_num,c("Patient ID","Age","Hospitalization length","First serum NT-proBNP","Second serum NT-proBNP","First urine NT-proBNP","First serum endothelin-1","Second serum endothelin-1","First urine endothelin-1","Second urine endothelin-1","First serum lipocalin-2","Second serum lipocalin-2","First urine lipocalin-2","Second urine lipocalin-2","Max. serum RBC count ","Max. sedimentation rate","Min. platelet count","Max. serum WBC count","Max. CRP","Max. creatinine","Max. urea","Min. urine volume","Max. urine RBC count ","Max. urine WBC count","Proteinuria","Max. AST","Max. ALT","Max. GGT"))
